         ...
         <div class="col-sm-12 col-xl-6">
             <div class="bg-light rounded h-100 p-4">
                 ...
                 <form action="<?php echo base_url() ?>index.php/purchase_form" method="post">
                     <input type="text" name="productID" class="form-control" id="" placeholder="" value="<?= $productID ?>">
                     ...
                     <div class="form-floating mb-3">
                         <input type="" name="total_cost" class="form-control" id="total_cost" placeholder="">
                         <label for="floatingInput">Cost</label>
                     </div>

                     <div class="form-floating mb-3">
                         <input type="" name="quantity_purchased" class="form-control" id="quantity_purchased" placeholder="">
